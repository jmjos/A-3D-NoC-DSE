...
if (isunix)
    otherFolder = 'Eingabe/Instanzen/Srinivasan_2'; % '../EE_Heuristik_Und_MILP';
else
    otherFolder = 'Eingabe/Instanzen/Srinivasan_2';
end
...
PaperSolution(1,1) = 11+1;
PaperSolution(2,1) = 10+1;
PaperSolution(2,2) = 9+1;
PaperSolution(2,4) = 7+1;
PaperSolution(3,1) = 2+1;
PaperSolution(3,2) = 3+1;
PaperSolution(3,4) = 8+1;
PaperSolution(4,1) = 6+1;
PaperSolution(4,2) = 5+1;
PaperSolution(4,3) = 0+1;
PaperSolution(4,4) = 1+1;
PaperSolution(4,5) = 4+1;
