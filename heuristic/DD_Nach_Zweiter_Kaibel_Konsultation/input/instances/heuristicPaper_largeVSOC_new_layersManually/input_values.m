...
%   - Cimpl etc. for AD-Wandler (Layer 1)
...
%   - Cimpl etc. for Prozessoren (Layer 2)
...
%   - Cimpl etc. for Viola Jones Units (Layer 2)
...
%   - Cimpl etc. for Shi Tomasi Units (Layer 3)
...
%   - Cimpl etc. for KLT Units (Layer 3)
