% It is 12.11.2018 and we want to see some of the rectangels of
% heterogeneous 9n9 in different colors.

function [] = plotResults_modified(componentPositions, ai, bi, networkGraph, saveasName, color1, color2, figureNumber)
    %color1 = 'y';
    %color2 = 'k';
