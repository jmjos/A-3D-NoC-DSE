...
if (isunix)
    otherFolder = 'Eingabe/Instanzen/Srinivasan_3'; % '../EE_Heuristik_Und_MILP';
else
    otherFolder = 'Eingabe/Instanzen/Srinivasan_3';
end
...
%% teilproblem 2 aus dem paper:

%zuordnung zu den feldern wie im paper:
PaperSolution = zeros(14,14);
PaperSolution(1,2) = 1+1;
PaperSolution(1,3) = 0+1;
PaperSolution(1,4) = 2+1;
PaperSolution(1,5) = 10+1;
PaperSolution(2,1) = 7+1;
PaperSolution(2,2) = 5+1;
PaperSolution(2,3) = 4+1;
PaperSolution(2,4) = 3+1;
PaperSolution(2,5) = 11+1;
PaperSolution(3,2) = 6+1;
PaperSolution(3,3) = 8+1;
PaperSolution(3,4) = 9+1;
PaperSolution(3,5) = 12+1;
